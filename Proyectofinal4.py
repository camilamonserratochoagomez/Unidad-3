...
def abrir_reportes():
            ...
            for linea in archivo_txt:
                if linea.strip():
                    ...
                    if len(datos) == 4:
                        ...
                        # Sumar total (último valor de cada línea)
    ...
    # ---------- Mostrar total de ventas con bordes ----------
...
try:
    BASE_DIR = os.path.dirname(os.path.abspath(__file__))
    imagen = Image.open(os.path.join(BASE_DIR, "ventas.png"))
...
# -------------------------
# ESTILO DE BOTONES (rosa pastel, letra negra, tamaño 12)
# -------------------------
estilo = ttk.Style()
...
estilo.configure(
    ...
    padding=10,
    foreground="black",
    background="#F7C6D0"  # Rosa pastel
)
estilo.map(
    "TButton",
    background=[("active", "#F2AFC0")]
)
